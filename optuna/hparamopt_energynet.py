...
parser.add_argument('--network', type=str, default='fno1d', choices=['deeponet', 'modified_deeponet', 'fno_timestepping' ,'fno1d', 'fno2d'], help='Network type')
...
if network == "deeponet":
    ...
    from networks.modified_deeponet import ModifiedDeepONet as OperatorNet, Hparams as OperatorHparams
elif network == "fno_timestepping":
    from networks.fno_timestepping import FNOTimeStepping as OperatorNet, Hparams as OperatorHparams
elif network == "fno1d":
    from networks.fno1d import FNO1d as OperatorNet, Hparams as OperatorHparams
elif network == "fno2d":
    from networks.fno2d import FNO2d as OperatorNet, Hparams as OperatorHparams
else:
