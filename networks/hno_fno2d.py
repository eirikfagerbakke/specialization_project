...
from jax import random, grad, vmap, jacfwd, value_and_grad
import jax.numpy as jnp
from dataclasses import dataclass
from typing import Type
from .energynet import EnergyNet, EnergyNetHparams
from .fno2d import FNO2d as OperatorNet, compute_loss as compute_operator_loss, Hparams as OperatorHparams
import sys
sys.path.append("..")
...
def compute_energy_loss(model, a, u, key):
    ...
    #x = model.u.encode_x(jnp.linspace(0, 20, 16, endpoint=False))
    #t = model.u.encode_t(jnp.linspace(0, 2, 16, endpoint=False))
