...
from jax import random, grad, value_and_grad, vmap, jacfwd, jacrev
...
def compute_loss_HINO(model, a, u, key, num_query_points=100):
    ...
    # vmap over a_batch    
    u_pred, u_t, 𝒢δℋ = vmap(model, (0, None, None))(a, Trainer.x, Trainer.t)
